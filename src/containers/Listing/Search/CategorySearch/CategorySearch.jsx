  ...
  return (
    <CategorySearchWrapper>
      ...
      <ViewWithPopup
        ...
        key={400}
        noView={true}
        view={<Button type="default">Escolha a data</Button>}
        popup={
          <DateRangePicker
            ...
            startDate={
              date_range.setStartDate
                ? moment(date_range.setStartDate, 'DD-MM-YYYY')
                : null
            }
            endDate={
              date_range.setEndDate
                ? moment(date_range.setEndDate, 'DD-MM-YYYY')
                : null
            }
            numberOfMonths={1}
            small={true}
      ...
      <ViewWithPopup
        ...
        view={
          <Button type="default">
            Quartos {countRoom > 0 && `: ${countRoom}`}, Hóspedes
