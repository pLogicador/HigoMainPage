...
const navigations = [
  {
    label: <NavLink to={AGENT_ACCOUNT_SETTINGS_PAGE}>Editar perfil</NavLink>,
    key: 'edit_profile',
  },
  {
    label: <NavLink to={AGENT_IMAGE_EDIT_PAGE}>Mudar foto</NavLink>,
    key: 'change_photos',
  },
  {
    label: <NavLink to={AGENT_PASSWORD_CHANGE_PAGE}>Mudar senha</NavLink>,
    key: 'change_password',
  },
];
