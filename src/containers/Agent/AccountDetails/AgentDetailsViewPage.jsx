...
const ProfileNavigation = (props) => {
  ...
  const navigations = [
    { label: <NavLink to={path}>Hoteis</NavLink>, key: 'listing' },
    {
      label: <NavLink to={AGENT_PROFILE_FAVORITE}>Favoritos</NavLink>,
      key: 'favorite',
    },
    {
      label: <NavLink to={AGENT_PROFILE_CONTACT}>Contato</NavLink>,
      key: 'contact',
    },
  ];
